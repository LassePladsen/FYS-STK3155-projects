...
def get_scaled_balanced_exoplanet_data(
    ...
    """Returns the exoplanet training and testing data from the data folder oversampled using the SMOTE algorithm from imblearn, then split into new train and test split using scikit-learns' train_test_split, and finally scaled using scikit-learn's StandardScaler"""
